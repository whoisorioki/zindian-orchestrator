...
print(
    "human_gate_2_anchor-baseline_label_approved raw value:",
    repr(state.get("human_gate_2_anchor-baseline_label_approved")),
)
print("anchor_git_branch raw value:", repr(state.get("anchor_git_branch")))
print(
    "anchor_baseline_approved raw value:", repr(state.get("anchor_baseline_approved"))
)
