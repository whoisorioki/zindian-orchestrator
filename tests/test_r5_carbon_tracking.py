...
def test_carbon_estimate_defaults():
    ...
    assert result["tracker_method"] in ["codecarbon", "mlco2_formula", "not_instrumented"]
...
def test_telemetry_schema():
    ...
    # R5 fields
    assert "carbon_kg_estimate" in telemetry or telemetry.get("tracker_method") == "not_instrumented"
