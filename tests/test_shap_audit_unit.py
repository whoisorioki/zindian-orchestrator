...
def test_compute_shap_audit_monkeypatch(monkeypatch):
    ...
    monkeypatch.setattr(shap_mod, "_train_shap_fold_model", lambda a, b, c, d, seed: FakeModel())
    ...
    result = shap_mod._compute_shap_audit(df, feature_cols, "Occurrence Status", n_splits=3, seed=42)
